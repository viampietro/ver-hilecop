...
***** DONE InA_setv
***** DONE getv_idle
**** TODO [#B] sitpn2hvhdl_p_comp_ex (GenerateHVhdlFacts) [50%]
***** DONE gen_sitpn_infos_sil_lofPs
***** DONE gen_archi_p_comp_ex
...
***** TODO [#B] gen_inter_p_comp_ex (GenerateInterconnectionsFacts)
****** DONE conn_to_input_tcis_inv_beh 
****** DONE conn_to_input_tcis_inv_γ
****** TODO [#A] put_comp_nodup_comp_ids
****** TODO [#A] conn_to_output_tcis_nodup_comp_ids (GenerateInterconnectionsInvs)
****** TODO [#B] put_comp_p_comp_ex
******* TODO [#A] put_comp_aux_p_comp_ex
******** DONE put_comp_aux_inv_state
******** TODO [#A] InCs_NoDup_comp_eq
...
****** TODO [#A] conn_to_output_tcis_p_comp_ex_inv (GenerateInterconnectionsInvs)
***** TODO [#A] gen_ports_p_comp_ex
