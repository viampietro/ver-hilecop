...
***** DONE InA_setv
***** DONE getv_idle
**** TODO sitpn2hvhdl_p_comp_ex (GenerateHVhdlFacts) [50%]
...
******* DONE SIL_forall_A
****** DONE gen_tcis_t_comp_ex
***** TODO gen_inter_p_comp_ex
****** TODO gen_inter_p_comp_ex
******* TODO put_comp_p_comp_ex
******** TODO put_comp_aux_p_comp_ex
******* TODO conn_to_output_tcis_p_comp_ex_inv
